...
class RRT():
    ...
    def steer(self, rnd, nind):
        ...
        if currentDistance <= self.expandDis:
            ...
            if math.cos(theta) > math.sin(theta):
                newNode.x = nearestNode.x + 1
                newNode.y = nearestNode.y
            else:
                newNode.x = nearestNode.x
                newNode.y = nearestNode.y + 1
    ...
    def get_random_point(self):
        ...
        if random.randint(0, 100) > self.goalSampleRate:
            ...
            rnd = [random.randint(self.minrand, self.maxrand),
                   random.randint(self.minrand, self.maxrand)]
