...
class configure:
    def __init__(self, grid_x, grid_y, grid_z, safety_threshold, privacy_threshold, privacy_radius, starting_point, end_point, viewradius, alpha, beta, exploration_rate):
        self.grid_x = grid_x
        self.grid_y = grid_y
        self.grid_z = grid_z
